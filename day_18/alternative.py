    ...
    def distanceToAllKeys(self):
        ...
        def exploreRecursive(bots, inventory):
            ...
            for key, (pos, dist, botID) in self.reachableKeys(bots, inventory).items():
                ...
                distances.append(dist + exploreRecursive(bots, newInventory))
...
with open('../resources/input_18.txt') as f: rawTunnels = f.readlines()
rawTunnels = [list(s.strip()) for s in rawTunnels]
